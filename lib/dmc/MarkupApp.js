                ...
                for (let w in termData) {
                    ...
                    while (hits = re.exec(paragraphNode.content)) {
		                ...
		                if (cmdState.mode == "create") {
							...
							// Save ext-link ID
							term.extLinkId = selectionState.getAnnotationsForType("ext-link")[0].id;
                           ...
                           // selectionState.getAnnotationsForType("ext-link")[0].attributes['xlink:href'] = term.lexica[0].link ;
							...
							selectionState.getAnnotationsForType("ext-link")[0].hrefLink = term.lexica[0].link;
							console.log( selectionState.getAnnotationsForType("ext-link")[0])
