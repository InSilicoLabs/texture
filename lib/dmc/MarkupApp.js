...
class MarkupApp {
    ...
    render(data, callback) {
        ...
        let detailButton = "<input type='button' onclick='var e = document.getElementById(\"hitDetails\"); e.style.display = (e.style.display == \"block\") ? \"none\" : \"block\";'\ value='Toggle details'>";
        // finalMessage += "<ul>";
        finalMessage += "<hr/>";
