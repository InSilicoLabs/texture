...
class MarkupApp {
    ...
    render(data, callback) {
        ...
        let detailButton = "<input style='display: inline;' type='button' onclick='var e = document.getElementById(\"hitDetails\"); e.style.display = (e.style.display == \"block\") ? \"none\" : \"block\";'\ value='Toggle details'>";
        // finalMessage += "<ul>";
        finalMessage += detailButton ;
        finalMessage += "<hr/>";
        finalMessage += "<div id='hitDetails'>";
