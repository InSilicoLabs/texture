...
/*	constructor(parent, props = {}, options = {}) {
  ...
  render($$) { // eslint-disable-line
	...
	if(word.props && word.props.node.id.startsWith("superscript")) {
		console.log(word.props.node)
	}
	...
	if (node.id.length > 20) {
		...
		} else if(this.props.children[0].props && this.props.children[0].props.node.id.startsWith("superscript")) {
